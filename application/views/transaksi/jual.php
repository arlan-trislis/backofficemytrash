...
<div class="row">
            ...
            <div class="col-lg-4">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                <label for="rekening" class="col-sm-4 col-form-label">Status</label>
                <div class="input-group col-sm-8">
                  <input type="text" name="no_rekening" id="no_rekening" class="form-control" readonly=""value="<?php $level = $user['level'];
                                      if($level = 1){
                                        echo 'Admin';
                                      } ?>">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" value="<?= $user['name'] ?>" class="form-control" id="nama" name="nama" value="" readonly="">
                </div>
            ...
            <div class="col-lg-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Form Input Data Jual Sampah</h6>
                </div>
                <div class="card-body">
                  <div class="form-group row">
                      ...
                      <div class="col-auto col-sm-4">
                        <div class="input-group">
                          ...
                          <input readonly="" id="qty" type="text" class="form-control">
                        </div> 
                      </div>
                      <!-- <div class="col-sm-3">
                        <input readonly="" type="number" id="qty" name="qty" class="form-control"></input>
                      </div> -->
                  </div>  
                <div class="form-group row">
                ...
                <div class="col-sm-4">
                  <button type="button" id="jual" class="btn btn-primary"><i class="fa fa-paper-plane"></i> Input</button>  
                </div>                
                </div>
                </div>
              </div>
  ...
  $(document).on('click', '#jual', function()
    {
      ...
      if (kategori == '') {
        ...
        data: {'jual' : true,'harga': harga,'no_rekening' : no_rekening,'qty':qty, 'kategori' : kategori, 'kg' :kg,'invoice' :invoice}, 
        dataType : 'json',
...
$(document).on('click', '#proses', function()
    {    
      ...
      if (total < 1) {
        ...
        $.ajax({
        type :'POST',
        url:'<?=site_url('transaksi/prosesjual') ?>',
        data: {'proses_jual' : true,'no_rekening' : no_rekening,'invoice' : invoice,'total' :total,'bulan' : bulan}, 
        dataType : 'json',
        success: function(result) {
          if (result.success == true) {
           ...
           location.href='<?=site_url('transaksi/jual') ?>'
           } 
        })
      } 
    }
